  ...
  return (
    <section className="intro" id="intro">
      <div className="intro-content">
        <p className="intro-greeting">hey there, I'm</p>
        <h1 className="intro-name">Ryan Lee</h1>
        ...
        <p className="intro-bio">
          CS student @ UC Berkeley · building things that matter ·
          obsessed with clean systems and meaningful impact
        </p>
        ...
        <div className="intro-links">
          ...
          <a href="https://github.com/omgitsryanlee" target="_blank" rel="noreferrer" aria-label="GitHub">
          ...
          <a href="https://linkedin.com/in/omgitsryanlee" target="_blank" rel="noreferrer" aria-label="LinkedIn">
